...
public class UserService {
    ...
    // method that handles registration by taking in @param username and @param
    // password, returns the newUser
    ...
    /**
     * isUniqueUsername takes in a username and uses the userDAO method
     * findByUsername,
    ...
    /**
     * login takes in a username and a password and attempts to log in. If
     * successful
