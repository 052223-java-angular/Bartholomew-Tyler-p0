...
/**
* The ReviewsScreen class handles what information is presented to the user when it 
...
public class ReviewsScreen implements IScreen {
    ...
    //Handles displaying all of the reviews through a for loop, if that don't exist, it lets the user know
    ...
    //Handles the printing of the individual reviews as the go through the for loop in printReviews
    ...
    //Clears the screen at the start of the while loop to display all the necessary information
    //later in the loop
